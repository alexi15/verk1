...
void UI::addScientist()
{
    ...
    for (int i = 0; i < number; i++){
        ...
        if((scient.add(tempSci)))
            cout << "Scientist successfully added" << endl;
        else
            cout << "Error could not add scientist" << endl;
        cout << endl;
    }
}
...
void UI::addComputers()
{
    ...
    for (int i = 0; i < number; i++)
    {
        ...
        if((com.add(tempcom)))
            ...
            cout << "Error could not add computer" << endl;
        cout << endl;
    }
}
...
void UI::RemoveSci()
{
    ...
    {
        if(scient.Remove(Id))
            cout << "Scientist successfully removed" << endl;
        else
            cout << "Error could not remove scientist" << endl;
    }
}
...
void UI::RemoveCom()
{
    ...
    {
        if(com.Remove(Id))
            cout << "Computer successfully removed" << endl;
        else
            cout << "Error could not remove computer" << endl;
    }
...
void UI::RemoveRelation()
{
    ...
    if (comID > 0)
    {
        if(com.removeRelation(comID, sciID))
            cout << "Relation successfully removed" << endl;
        else
            cout << "Error could not remove relation" << endl;
    }
...
void UI::EditSci()
{
    ...
    if(scient.Edit(temp,inputId, inputEdit))
        cout << "Scienist successfully edited" << endl;
    else
...
void UI::EditCom()
{
    ...
    if(com.Edit(temp,inputId, inputEdit))
        cout << "Computer successfully edited" << endl;
    else
        cout << "Could not edit computer" << endl;
}
